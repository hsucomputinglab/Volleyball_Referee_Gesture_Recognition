...
from src.nn.modules.box_ops import box_cxcywh_to_xyxy, generalized_box_giou, generalized_box_eiou
...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, weight_dict, use_focal_loss=False, alpha=0.25, gamma=2.0):
        ...
        self.cost_iou = weight_dict.get('cost_iou', 2)
    ...
    def forward(self, outputs, targets):
        ...
        cost_iou = -generalized_box_eiou(box_cxcywh_to_xyxy(out_bbox), box_cxcywh_to_xyxy(tgt_bbox))
