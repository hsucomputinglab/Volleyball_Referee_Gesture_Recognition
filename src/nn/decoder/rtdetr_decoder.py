...
from src.nn.modules.denoising import get_contrastive_denoising_training_group
from src.nn.modules.common import get_activation
from src.nn.modules.utils import inverse_sigmoid, bias_init_with_prob, deformable_attention_core_func
    ...
    def forward(self,
        ...
        for i, layer in enumerate(self.layers):
            ...
            output = layer(output, ref_points_input, memory,
                           memory_spatial_shapes, memory_level_start_index, dn_meta,
...
class RTDETRTransformer(nn.Module):
    ...
    def _generate_anchors(self,
        ...
        return anchors.cuda(), valid_mask.cuda()
    ...
    def _get_decoder_input(self,
        ...
        if not self.training:
            anchors = anchors.to(memory.dtype)
